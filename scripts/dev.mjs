...
const mf=new Miniflare({modules:true,scriptPath:'dist/server/index.js',compatibilityDate:'2026-05-15',port:Number(process.env.PORT)||4317,host:'127.0.0.1',d1Databases:{DB:'speakx-local'},d1Persist:'.local/db',r2Buckets:['BUCKET'],r2Persist:'.local/r2',bindings:{LOCAL_PREVIEW:'true',PROVIDER_VAULT_KEY:previewVaultKey}});
