...
## Live full-script proof — 22 September 2026

Kling Avatar Standard task `642ff17fc7236704f8dd4edb5495a1a2` completed for job `2e9144d5-3e4a-40e8-aa1d-a8d88dd93e81` (Video V3, Script V4). It reused the full 22.4-second Cartesia narration from the failed InfiniteTalk take without resynthesizing speech. Kie's documented temporary result host was added to the exact HTTPS allowlist; the existing task was resumed without a second paid request. Regression suite: 18/18 passed.

The browser rendered and saved a real 720×1280 MP4 with sentence-aligned captions. Downloaded-file FFprobe verified 22.4406 seconds H.264 video and 22.4196 seconds AAC audio; mean volume −14.2 dB, peak −0.6 dB. Initial streaming metadata reported only the first MP4 fragment; full-file duration is authoritative. Three sampled frames showed Sia, an office background, captions and SpeakX branding. Provider-generated glyph artifacts were visible below the captions; a separate review export masks that lower region and has fast-start metadata, with the same audio copied unchanged. It is 22.466 seconds. Final voice/pronunciation/lip-sync review remains human QA; no publishing approval was fabricated.
